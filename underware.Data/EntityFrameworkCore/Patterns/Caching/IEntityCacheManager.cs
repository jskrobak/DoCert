using underware.Data.EntityFrameworkCore.Patterns.UnitOfWorks;

namespace underware.Data.EntityFrameworkCore.Patterns.Caching;
  ...
  public interface IEntityCacheManager
  {
    ...
    /// </summary>
    bool TryGetEntity<TEntity>(object key, out TEntity entity) where TEntity : class;

    /// <summary>Uloží do cache předanou entitu.</summary>
    void StoreEntity<TEntity>(TEntity entity) where TEntity : class;
    ...
    /// <summary>Uloží do cache kolekci předané entity.</summary>
    ...
    /// </summary>
    bool TryGetAllKeys<TEntity>(out object keys) where TEntity : class;

    /// <summary>
    /// Uloží do cache objekt reprezentující klíče všech entity (pro metodu GetAll).
    /// </summary>
    void StoreAllKeys<TEntity>(object keys) where TEntity : class;
