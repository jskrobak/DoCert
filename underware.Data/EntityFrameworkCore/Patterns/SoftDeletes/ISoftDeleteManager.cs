...
/// <summary>Zajišťuje podporu mazání příznakem.</summary>
public interface ISoftDeleteManager
{
    ...
    /// </summary>
    /// <exception cref="T:System.NotSupportedException">Na typu TEntity není podporováno mazání příznakem.</exception>
    void SetDeleted<TEntity>(TEntity entity);

    /// <summary>Zruší příznak smazání, je-li nastaven.</summary>
    /// <exception cref="T:System.NotSupportedException">Na typu TEntity není podporováno mazání příznakem.</exception>
