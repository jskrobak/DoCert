...
namespace underware.Data.EntityFrameworkCore;
  ...
  public interface IDbContext : IDisposable
  {
    ...
    /// </summary>
    /// <remarks>Pro zjednodušení předáváme celý objekt bez wrapperu.</remarks>
    ChangeTracker ChangeTracker { get; }

    /// <summary>Uloží změny.</summary>
    void SaveChanges();
    ...
    /// <summary>Vrátí aktuální stav entity.</summary>
    ...
    /// <summary>Vrátí entity entries všech zaregistrovaných entit.</summary>
    EntityEntry[] GetEntries(bool suppressDetectChanges);

    /// <summary>
    /// Vrací true, pokud je EF považuje vlastnost za načtenou.
    /// </summary>
    bool IsNavigationLoaded<TEntity>(TEntity entity, string propertyName) where TEntity : class;

    /// <summary>
    /// Nastaví navigation property (kolekce, reference) jako načtenou.
    /// </summary>
    void MarkNavigationAsLoaded<TEntity>(TEntity entity, string propertyName) where TEntity : class;
  }